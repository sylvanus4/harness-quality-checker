...
| ✅ **Loader fetches are outbound GETs of public files** | When you "Load from a URL", the browser performs a plain `GET` of that **public** file from `raw.githubusercontent.com` (CORS-open). It sends no credentials and none of your other input; it's the same as opening that URL in a tab. Dropped files never leave your machine. |
